          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <p className="text-[#00235A] text-lg leading-relaxed">
                ...
                travel, or property assistance, our team ensures a seamless and
                trusted experience.
              </p>
            </div>
          </div>
        ...
        <section className="py-16 md:py-24 px-6 md:px-12 bg-white">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-[#00235A] text-lg max-w-3xl">
              We specialise in car rentals, transport logistics, fleet
              management, and estate/property services — providing reliable and
              efficient support tailored to your needs.
            </p>
          </div>
        </section>
      </section>
